<template>
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"
       stroke-linecap="round" stroke-linejoin="round" v-html="paths[name] || paths.dot"></svg>
</template>

<script setup>
defineProps({ name: { type: String, default: 'dot' } });

// One consistent outline icon set (Feather/Lucide-style), stroke=currentColor.
const paths = {
  dashboard: '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/>',
  'user-plus': '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/>',
  stethoscope: '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>',

...
const routes = [
...

    {
        ...
        children: [
            ...
            { path: 'pre-op',         component: () => import('./pages/Hospital/ComingSoon.vue'), meta: { page: 'surgery', title: 'Pre-Op Planning', note: 'Pre-operative planning checklist & sign-off is under construction. API: /api/hospital/pre-op-plans.', back: '/hospital/surgery' } },
            { path: 'implants',       component: () => import('./pages/Hospital/ComingSoon.vue'), meta: { page: 'surgery', title: 'Implant Stock', note: 'Implant inventory & usage tracking is under construction. API: /api/hospital/implants.', back: '/hospital/surgery' } },
            ...
            { path: 'discharge',      component: () => import('./pages/Hospital/ComingSoon.vue'), meta: { page: 'inpatients', title: 'Discharge', note: 'Discharge summaries & workflow are under construction. Manage admissions in Bed Management for now.', back: '/hospital/admissions' } },
        ],
    },

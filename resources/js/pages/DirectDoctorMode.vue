<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-xl font-bold text-gray-900">Direct Doctor Mode</h1>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-5">
      <h2 class="font-semibold text-gray-800 mb-4">Step 1 — Find or Register Patient</h2>
    ...
    <div v-if="patient">
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-5">
        <h2 class="font-semibold text-gray-800 mb-3">Step 2 — Visit History</h2>
        <VisitHistory :patient-id="patient.id" />
      </div>

      <!-- Step 3: SOAP + clinical -->
      <div class="bg-white rounded-xl border border-gray-200 p-5 space-y-6">
        <h2 class="font-semibold text-gray-800">Step 3 — Clinical Assessment</h2>
      ...
      <div v-if="savedRecordId" class="bg-white rounded-xl border border-gray-200 p-5 space-y-6">
        <h2 class="font-semibold text-gray-800">Step 4 — Treatment & Exercise</h2>
      ...
      <div v-if="savedRecordId" class="bg-white rounded-xl border border-gray-200 p-5">
        <h2 class="font-semibold text-gray-800 mb-4">Step 5 — Prescription (optional)</h2>
        <PrescriptionForm :patient-id="patient.id" :clinical-record-id="savedRecordId" />
      </div>

      <!-- Step 6: Invoice + Print -->
      <div v-if="savedRecordId" class="bg-white rounded-xl border border-gray-200 p-5">
        <h2 class="font-semibold text-gray-800 mb-4">Step 6 — Invoice & Print</h2>
